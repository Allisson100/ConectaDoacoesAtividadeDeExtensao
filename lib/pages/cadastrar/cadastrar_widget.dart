              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        var doacaoRecordReference =
                            DoacaoRecord.collection.doc();
                        await doacaoRecordReference.set(createDoacaoRecordData(
                          nomeItem: _model.textController1.text,
                          nomePessoa: _model.textController2.text,
                          tel: _model.textController3.text,
                          endereco: _model.textController4.text,
                          descricao: _model.textController5.text,
                        ));
                        _model.pronto = DoacaoRecord.getDocumentFromData(
                            createDoacaoRecordData(
                              nomeItem: _model.textController1.text,
                              nomePessoa: _model.textController2.text,
                              tel: _model.textController3.text,
                              endereco: _model.textController4.text,
                            ...
                            doacaoRecordReference);
                        if (_model.pronto?.reference != null) {
                          safeSetState(() {
